...
import { approvedReturnedBorrowedBook } from '../fn/book/approved-returned-borrowed-book';
import { ApprovedReturnedBorrowedBook$Params } from '../fn/book/approved-returned-borrowed-book';
...
import { ReturnedBorrowedBook$Params } from '../fn/book/returned-borrowed-book';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `returnedBorrowedBook()` */
  static readonly ReturnedBorrowedBookPath = '/books/borrow/return/{bookId}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `returnedBorrowedBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  returnedBorrowedBook$Response(params: ReturnedBorrowedBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return returnedBorrowedBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `returnedBorrowedBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  returnedBorrowedBook(params: ReturnedBorrowedBook$Params, context?: HttpContext): Observable<number> {
    return this.returnedBorrowedBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }

  /** Path part for operation `approvedReturnedBorrowedBook()` */
  static readonly ApprovedReturnedBorrowedBookPath = '/books/borrow/return/approve/{bookId}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `approvedReturnedBorrowedBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  approvedReturnedBorrowedBook$Response(params: ApprovedReturnedBorrowedBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return approvedReturnedBorrowedBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `approvedReturnedBorrowedBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  approvedReturnedBorrowedBook(params: ApprovedReturnedBorrowedBook$Params, context?: HttpContext): Observable<number> {
    return this.approvedReturnedBorrowedBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
